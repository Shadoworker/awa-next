...
import './MenubarDashboardComp.css';
import { withRouter } from 'next/router';
import Image from 'next/image';

const CHECK_ITEMS = ['Always Show Bookmarks Bar', 'Always Show Full URLs'];

class MenubarDashboardComp extends Component<any, any> {
  ...
  render(){
    return <Menubar.Root className="MenubarRoot PreviewMenubarRoot">
      <Menubar.Menu>
        <Menubar.Trigger className="MenubarTrigger"><Image alt='' src={require('../../assets/icons/logo_colored_white.png')} style={{height:10, width:'auto'}} /> <span>&#x2022;</span></Menubar.Trigger>
          <Menubar.Portal>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(MenubarDashboardComp));
