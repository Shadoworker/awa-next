...
*/
import { DEFBASE_ID_BODY, GRAD, GRADIENT_ID_BODY, GRADIENT_ID_BODYIENT_ID_BODY } from "../../awa/awa.constants";
  ...
  **/
  ...
  class Element extends Dom {
    constructor(node, attrs) {
      ...
      this.node.baseStroke = {id:null, color : '#ffffff'};
    ...
    setBackgroundElement(_mediaType=null, _media=null)
    {
        ...
        var backgroundId = _elemId+GRADIENT_ID_BODY+"--"+_colorType //+"--"+new Date().getTime();

        var background = svgInstance.findOne("#"+backgroundId);

        if(background) background.remove();

        var gradient = svgInstance.gradient(_type).attr({id : backgroundId});
