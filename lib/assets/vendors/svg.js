...
*/
import { DEFBASE_ID_BODY, DEFBG_ID_BODY, GRAD, GRADIENT_ID_BODY, GRADIENT_ID_BODYIENT_ID_BODY, PATTERN_BG_ID_BODY } from "../../awa/awa.constants";
  ...
  **/
  ...
  class Element extends Dom {
    constructor(node, attrs) {
      ...
      this.node.baseBackground = {id : null, type:null, media : null};
      this.node.effects = [];
    ...
    baseBackground(baseId, baseType, baseMedia)
    {
      if(arguments.length == 0)
        return this.node.baseBackground;

      this.node.baseBackground = {id : baseId, type:baseType, media : baseMedia};;
    ...
    setBackgroundElement(_mediaType=null, _media=null)
    {
        var _elemId = this.attr('id');
