...
const USER_ACTION_EVENTS = {
    ...
    SELECTED_SCENE_ITEMS: "EVENT_SELECTED_SCENE_ITEMS", //
    ...
    TOGGLE_COLOR_PICKER: "EVENT_TOGGLE_COLOR_PICKER", //
    UPDATE_INPUT_COLOR: "EVENT_UPDATE_INPUT_COLOR", //

    TOGGLE_MEDIA_PICKER : "EVENT_TOGGLE_MEDIA_PICKER",
    UPDATE_INPUT_MEDIA: "EVENT_UPDATE_INPUT_MEDIA", //
